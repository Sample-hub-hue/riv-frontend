...
interface CompanyDetailsProps {
  onComplete: () => void;  // This will be triggered when the user clicks "Next ->"
}

export default function CompanyDetails({ onComplete }: CompanyDetailsProps) {
  return (
        ...
        <div className="absolute w-[550px] h-fit left-[calc(50%-275px+1px)] top-[calc(50%-416.065px+44.57px)] bg-white shadow-[5.03598px_5.03598px_16.259px_rgba(0,0,0,0.25)] rounded-[20.4264px]">
          <div className="flex flex-col justify-center items-center h-full p-4">
            ...
            <form>
              ...
              <button
                type="button"
                onClick={onComplete}  // Trigger the transition to UserDetails
                className="justify-center text-white text-xl text-bold w-[14vw] h-[7vh] justify-center items-center gap-[6.667px] flex-shrink-0 rounded-[10px] bg-black"
              >
                Next ->
              </button>
            </form>
